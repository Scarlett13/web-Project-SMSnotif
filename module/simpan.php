...
include "../config/conn.php";
	...
	// $sql = $con->prepare('select * from guru where idg= ?');
 //    $sql->execute(['$_GET[idg]']);
 //    $rs = $sql->fetch();

if($_GET['act']=="input_user"){
$pw=md5($_POST['pass']);
$insU=$con->prepare("INSERT INTO user(nama,pass,level,id)"); 
$insU->execute(array(
'$_POST[nama]',
'$pw',
...
if(!empty($_POST['pass'])){
$pw=md5($_POST['pass']);
$updU=$con->prepare("update user set nama='$_POST[nama]',
pass='$pw',id='$_POST[sekolah]' where idu='$_POST[idu]'");
$updU->execute();
}else{
$updU=$con->prepare("update user set nama='$_POST[nama]',id='$_POST[sekolah]' where idu='$_POST[idu]'");	
$updU->execute();
...
$delU=$con->prepare("delete from user where idu='$_GET[idu]'");
$delU->execute();
...
$insS=$con->prepare("INSERT INTO siswa(nis,nama,jk,alamat,idk,tlp,bapak,k_bapak,ibu,k_ibu,pass") ;
$insS->execute(array(
":nis"=>"$_POST[nis]",
":nama"=>"$_POST[nama]",
":jk"=>"$_POST[jk]",
